...
int nAnonymizeUltraClearAmount = 1000;
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "ucr" is a composite category enabling all UCR-related debug output
            if (ptrCategory->count(string("ucr"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ucr.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ucrd.pid"));
