...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ultra Clear"), this);
    aboutAction->setStatusTip(tr("Show information about Ultra Clear"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Ultra Clear help message to get a list with possible UCR command-line options"));
