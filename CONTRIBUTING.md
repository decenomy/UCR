Contributing to Ultra Clear
============================

The Ultra Clear project operates an open contributor model where anyone is
...
The following applies to code changes to the Ultra Clear project, and is not to be
confused with overall UltraClear Network Protocol consensus changes.

Whether a pull request is merged into Ultra Clear rests with the project merge
...
Where a patch set proposes to change the UltraClear consensus, it must have been
...
The project leader is the release manager for each Ultra Clear release.
