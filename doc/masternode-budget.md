...
UltraClear now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ucr_address\> \<monthly_payment_ucr\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ UltraClear, _12_ times over the course of a year totaling _24000_ UltraClear.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ucr_address\> \<monthly_payment_ucr\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` UltraClear.
 ...
 * vote-many          - Vote on a UltraClear initiative
 * vote-alias         - Vote on a UltraClear initiative
 * vote               - Vote on a UltraClear initiative/budget
