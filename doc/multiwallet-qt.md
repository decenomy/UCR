...
In order to support loading of multiple wallets in ucr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ucr.cpp.
...
Changes to ucr.cpp
----------------------
ucr.cpp is the entry point into ucr-qt, and as such, will require some minor modifications to provide hooks for
